...
e = Event.create({
  ...
  starts_at: DateTime.parse('Fri, 11 Mar 2018 7:00 AM+0700'),
  ends_at: DateTime.parse('Sun, 13 Mar 2018 3:00 PM+0700'),
  venue: dalat,
  publish: true,
  category: Category.find_by(name: 'Everything Else'),
  hero_image_url: 'https://az810747.vo.msecnd.net/eventcover/2018/10/25/C6A1A5.jpg?w=1040&maxheight=400&mode=crop&anchor=topcenter',
  extended_html_description: <<-DESC
    <p style="text-align:center"><span style="font-size:20px">VIỆT NAM THỬ THÁCH CHIẾN THẮNG 2018</span></p>
    <p style="text-align:center"><span style="font-size:20px">Giải đua xe đạp địa hình 11-13/03/2018</span></p>
    ...
    <p style="text-align:center"><span style="font-size:16px">Để biết thêm thông tin chi tiết và tạo thêm hứng khởi cho cuộc đua 2018, vui lòng ghé thăm trang web</span></p>
...
e.ticket_types << TicketType.create(name: '2018 Việt Nam Thử Thách Chiến Thắng dành cho những tay đua đăng kí sớm.', price: 500000, max_quantity: 95)
...
e = Event.create({
  ...
  starts_at: DateTime.parse('Sat, 16 Jan 2018, 8:00 PM+0700'),
  ends_at: DateTime.parse('Sat, 16 Jan 2018, 10:30 PM+0700'),
  publish: true,
  hero_image_url: 'https://az810747.vo.msecnd.net/eventcover/2018/12/11/C68636.jpg?w=1040&maxheight=400&mode=crop&anchor=topcenter',
  extended_html_description: <<-DESC
  <p style="text-align:justify"> </p>

  <p style="text-align:justify">Đan Trường cũng tiết lộ kế hoạch chuẩn bị cho live show kỷ niệm 20 năm ca hát của anh, sẽ diễn ra vào ngày 16-1-2018. “Nói ra, mọi người bảo tôi lo xa nhưng tính tôi là vậy. Tôi là người kỹ tính và chỉn chu trong mọi việc nên không cho phép sai sót, dù nhỏ, trong live show của mình. Để đạt được điều ấy, tôi phải chuẩn bị thật kỹ. Đó là chưa kể có rất nhiều chuyện phải làm cho đến khi diễn ra live show, như phát hành các sản phẩm âm nhạc” - anh tâm sự.</p>

  <p style="text-align:justify"> </p>

  <p style="text-align:justify"><img src="https://az810747.vo.msecnd.net/agenda/2018/12/14/57EEE9.jpg" /></p>
  ...
  <p style="text-align:justify"><img src="https://az810747.vo.msecnd.net/agenda/2018/12/14/06EAAD.jpg" /></p>
  ...
  <p style="text-align:justify"><img src="https://az810747.vo.msecnd.net/agenda/2018/12/14/0714C1.jpg" /></p>
...
e = Event.create({
  ...
  starts_at: DateTime.parse('Thu, 24 Dec 2018, 8:00 PM+0700'),
  ends_at: DateTime.parse('Thu, 24 Dec 2018, 11:00 PM+0700'),
  venue: gap,
  publish: true,
  category: Category.find_by(name: 'Entertainment'),
  hero_image_url:'https://az810747.vo.msecnd.net/eventcover/2018/12/12/78534E.jpg?w=1040&maxheight=400&mode=crop&anchor=topcenter',
  extended_html_description: <<-DESC
         <p>
